    ...
    <div className="mt-24 bg-gray-100 px-4 py-24 text-sm md:px-8 lg:px-16 xl:px-32 2xl:px-64">
      ...
      <div className="flex flex-col justify-between gap-24 md:flex-row">
        ...
        <div className="flex w-full flex-col gap-8 md:w-1/2 lg:w-1/4">
          ...
          <p>
            3252 Winding Way, Central Plaza, Willowbrook, CA 90219, United
            States
          </p>
          <span className="font-semibold">yeldynovn@gmail.com</span>
          <span className="font-semibold">+380979693424</span>
        ...
        <div className="flex w-full flex-col gap-8 md:w-1/2 lg:w-1/4">
          ...
          <div className="flex">
            <input
              ...
              className="w-3/4 p-4"
            />
            <button className="w-1/4 bg-softRed text-white">JOIN</button>
          </div>
